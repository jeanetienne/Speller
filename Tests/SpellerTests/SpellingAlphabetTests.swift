...
class SpellingAlphabetTests: XCTestCase {
    ...
    func testInternationalRadiotelephony() {
        let content = SpellingAlphabet.InternationalRadiotelephony.load()
    ...
    func testInternationalRadiotelephonyNumbers() {
        let content = SpellingAlphabet.InternationalRadiotelephonyNumbers.load()
        let control: SpellingAlphabetContent =
            ["1": "Unaone",      "2": "Bissotwo",
        ...
        XCTAssertEqual(content, control, "International Radiotelephony Numbers spelling alphabet has changed")
    }

    func testUSFinancial() {
        let content = SpellingAlphabet.USFinancial.load()
        let control: SpellingAlphabetContent =
            ["A": "Adam",    "B": "Bob",
             "C": "Carol",   "D": "David",
             "E": "Eddie",   "F": "Frank",
    ...
    func testLAPD() {
        let content = SpellingAlphabet.LAPD.load()
        let control: SpellingAlphabetContent =
            ["A": "Adam",    "B": "Boy",
             "C": "Charles", "D": "David",
             "E": "Edward",  "F": "Frank",
    ...
    func testFrench() {
        let content = SpellingAlphabet.French.load()
        let control: SpellingAlphabetContent =
            ["A": "Anatole",     "B": "Berthe",
             "C": "Célestin",    "D": "Désiré",
             "E": "Eugène",      "F": "François",
    ...
    func testBasicLatin() {
        let content = SpellingAlphabet.BasicLatin.load()
        let control: SpellingAlphabetContent =
            [" " : "Space",
             "!" : "Exclamation mark",
             "\"": "Quotation mark",
        ...
        XCTAssertEqual(content, control, "Basic Latin spelling alphabet has changed")
    }

    func testLatin1Supplement() {
        let content = SpellingAlphabet.Latin1Supplement.load()
        let control: SpellingAlphabetContent =
        ...
        XCTAssertEqual(content, control, "Latin 1 Supplement spelling alphabet has changed")
    }

    func testLatinExtendedA() {
        let content = SpellingAlphabet.LatinExtendedA.load()
        let control: SpellingAlphabetContent =
        ...
        XCTAssertEqual(content, control, "Latin Extended A spelling alphabet has changed")
    }

    func testLatinExtendedB() {
        let content = SpellingAlphabet.LatinExtendedB.load()
        let control: SpellingAlphabetContent =
        ...
        XCTAssertEqual(content, control, "Latin Extended B spelling alphabet has changed")
    }
